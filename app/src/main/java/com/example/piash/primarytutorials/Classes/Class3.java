...
public class Class3 extends AppCompatActivity {
    ...
    private String HttpUrl = Link + "Class3Data.php";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        new GetHttpResponse(Class3.this).execute();
        ...
        tutorialListView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                Intent intent = new Intent(Class3.this, ShowSingleDataToUser.class);
    ...
    private class GetHttpResponse extends AsyncTask<Void, Void, Void> {
        ...
        protected void onPostExecute(Void result) {
            ...
            try{
                ...
                Intent intent = new Intent(Class3.this, AllClassesActivity.class);
                startActivity(intent);
