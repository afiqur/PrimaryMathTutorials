...
public class Class2 extends AppCompatActivity {
    ...
    private String HttpUrl = Link + "Class2Data.php";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        new GetHttpResponse(Class2.this).execute();
        ...
        tutorialListView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                Intent intent = new Intent(Class2.this, ShowSingleDataToUser.class);
    ...
    private class GetHttpResponse extends AsyncTask<Void, Void, Void> {
        ...
        protected void onPostExecute(Void result) {
            ...
            try{
                ...
                Intent intent = new Intent(Class2.this, AllClassesActivity.class);
                startActivity(intent);
